function [optimal_rho, max_value] = optimizeRho_fminsearch(Q, pi_matrix, g_matrix, R, rho_star)
...
%   max_value   - The maximum value of E0(ρ) - ρR
    ...
    [optimal_rho, max_neg_value] = fminsearch(@objective, rho, options);
